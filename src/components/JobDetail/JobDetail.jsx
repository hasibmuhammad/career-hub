...
const JobDetail = () => {
  ...
  return (
    <div className="relative bg-bg1 bg-no-repeat">
      ...
      <div className="max-w-7xl mx-auto mt-32 px-10">
        <div className="flex gap-4">
          ...
          <div>
            ...
            <button className="w-full mt-6 px-7 py-4 rounded-lg bg-gradient-to-r from-start to-end font-extrabold text-white">
              Apply Now
            </button>
          </div>
        </div>
